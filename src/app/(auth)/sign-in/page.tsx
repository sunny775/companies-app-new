...
export default async function SignInPage(props: { searchParams: Promise<{ callbackUrl: string | undefined }> }) {
  ...
  return (
    <div className="h-[calc(100vh-64px)] bg-[rgb(50,60,50)] bg-[linear-gradient(-45deg,#fff_5px,transparent_200px)] dark:bg-[linear-gradient(-45deg,#000_5px,transparent_200px)] bg-[length:40px_40px]">
      <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)] w-full p-4 bg-gradient-to-b from-background/70 via-transparent to-background">
        <Logo className="my-8" />
